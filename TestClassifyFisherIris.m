...
% [C,err,P,logp,coeff] = classify([X Y],[SL SW],group,'diaglinear');
% [C,err,P,logp,coeff] = classify([X Y],[SL SW],group,'quadratic');
% [C,err,P,logp,coeff] = classify([X Y],[SL SW],group,'diagquadratic');
[C,err,P,logp,coeff] = classify([X Y],[SL SW],group,'mahalanobis');
